...
namespace Emlak
{
    public partial class EvDuzenleme : Form
    {
        ...
        private void groupBox_satilik_ev_Enter(object sender, EventArgs e)
        {

        }

        private void textBox_satilikEv_fiyat_TextChanged(object sender, EventArgs e)
        {

        }

        private void groupBox_satilik_ev_Enter_1(object sender, EventArgs e)
        {
