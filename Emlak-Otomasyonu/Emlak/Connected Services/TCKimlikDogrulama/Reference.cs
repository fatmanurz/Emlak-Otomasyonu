...
namespace Emlak.TCKimlikDogrulama {
    ...
    public interface KPSPublicSoap {
        ...
        Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : Emlak.TCKimlikDogrulama.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<Emlak.TCKimlikDogrulama.KPSPublicSoap>, Emlak.TCKimlikDogrulama.KPSPublicSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaResponse Emlak.TCKimlikDogrulama.KPSPublicSoap.TCKimlikNoDogrula(Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequest request) {
        ...
        public bool TCKimlikNoDogrula(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequest inValue = new Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequest();
            inValue.Body = new Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaResponse retVal = ((Emlak.TCKimlikDogrulama.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaResponse> Emlak.TCKimlikDogrulama.KPSPublicSoap.TCKimlikNoDogrulaAsync(Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequest request) {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili) {
            Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequest inValue = new Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequest();
            inValue.Body = new Emlak.TCKimlikDogrulama.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((Emlak.TCKimlikDogrulama.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
    }
}
